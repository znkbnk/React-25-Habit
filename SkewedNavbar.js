...
export default function SkewedNavbar(props) {
  ...
  const handleBackgroundClick = () => {
    setIsBlackBackground((prev) => !prev); // Toggle the background color
  };

  const handleDeleteClick = () => {
    setShowDeletedHabits(!showDeletedHabits);
    props.onDeleteClick(); // Call the prop function
  };

  const handleRegisterClick = () => {
    setIsRegistrationVisible(!isRegistrationVisible);
    props.onRegisterClick(); // Call the prop function
  };

  const handleFavoriteClick = () => {
    setShowFavoriteHabits(!showFavoriteHabits);
    props.onFavoriteClick(); // Call the prop function
  };

  const handleCompletedClick = () => {
    setCompletedHabits(!completedHabits);
    props.onCompletedClick(); // Call the prop function
  };

  const handleCategoriesClick = () => {
    setShowCategoriesDropdown(!showCategoriesDropdown);
    props.onCategoriesClick(); // Call the prop function
  };
